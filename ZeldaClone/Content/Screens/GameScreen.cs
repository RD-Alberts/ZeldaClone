...
using ZeldaClone.Content.PlayerClass;
using ZeldaClone.Recources;
using ZeldaClone.Content.Level;

namespace ZeldaClone.Content.Screens
{
    class GameScreen : Screen
    {
        ...
        public GameScreen()
        {
            player = new Player(Assets.player, new Vector2(100, 150));
            grid = new Grid();
            grid.createLevel(1);
